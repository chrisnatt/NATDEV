/* checksum : d4c39eb9607621f1e0f359befce5303a */
@cds.external : true
...
entity ZAPI_BUSINESS_PARTNER.A_BPEmployment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BPTaxCompliance {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartner {
  ...
  to_BPEmployment : Association to many ZAPI_BUSINESS_PARTNER.A_BPEmployment {  };
  ...
  to_BPTaxCompliance : Association to many ZAPI_BUSINESS_PARTNER.A_BPTaxCompliance {  };
  ...
  to_BusinessPartnerAlias : Association to many ZAPI_BUSINESS_PARTNER.A_BusinessPartnerAlias {  };
  ...
  to_BusinessPartnerIsBank : Association to ZAPI_BUSINESS_PARTNER.A_BusinessPartnerIsBank {  };
...
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity ZAPI_BUSINESS_PARTNER.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
